...
import projectcss from "../website_starter/plasmic.module.css"; // plasmic-import: q2NWcCtc7KJ2FCmeE4U5Q6/projectcss
import sty from "./PlasmicButton.module.css"; // plasmic-import: dxsOp7BM0-5m/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: pqJ6DcBNJV7y/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: u_PIlrUCOrFL/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__oIL)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__bxbon)}
                role={"img"}
              />
            ),
